...
if($result && $result_background && $result_profile && $result_about){
    ...
    if($array_background['date']<10){
        ...
        if($array_profile['date']<10){
            $_SESSION['date_profile'] = "0".$array_background['date'];
        } else {
            $_SESSION['date_profile'] = $array_background['date'];
            
        }
        if($array_background['month']<10){
            $_SESSION['month_profile'] = "0".$array_background['month'];
        } else {
            $_SESSION['month_profile'] = $array_background['month'];

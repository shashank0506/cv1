...
<div class="notification" style="border: 1px solid;background: beige;width: 800px;font-family: cursive;">
    ...
    <form method="post" action="#">
        ...
        <input type="number" name="id_request" value="<?php echo $array_user['id'];?>" style="display:none;">
        <input type="submit" class="btn btn-primary" value="confirm" name="confirm" id="confirm"><label></label>
        <input type="submit" class="btn btn-danger" value="ignore" name="ignore">
